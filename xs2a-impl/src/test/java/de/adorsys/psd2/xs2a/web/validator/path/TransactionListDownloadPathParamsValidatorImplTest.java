...
public class TransactionListDownloadPathParamsValidatorImplTest {
    ...
    private static final String DOWNLOAD_URL_SUFFIX = "download-url-suffix";
    ...
    public void validate_success() {
        ...
        pathParametersMap.put(DOWNLOAD_URL_SUFFIX, CORRECT_BASE64_STRING);
    ...
    public void validate_wrongBase64_shouldFail() {
        // Given
        Map<String, String> pathParametersMap = new HashMap<>();
        pathParametersMap.put(DOWNLOAD_URL_SUFFIX, WRONG_BASE64_STRING);
        ...
        assertEquals(messageError.getTppMessage().getText(), "Path parameter 'download-url-suffix' has to be represented by Base64 representation");
    }
}
