...
public class TransactionsReportDownloadLinks extends AbstractLinks {
    ...
    public TransactionsReportDownloadLinks(String httpUrl, String accountId, boolean withBalance, String downloadSuffix) {
        super(httpUrl);

        if (downloadSuffix != null) {
            setDownload(buildPath(UrlHolder.ACCOUNT_TRANSACTIONS_DOWNLOAD_URL, downloadSuffix));
        }
