...
public interface AccountSpi {
     ...
     * @param contextData              known Context of this call
     * @param accountConsent           SpiAccountConsent
     * @param downloadUrlSuffix        a link suffix, provided by ASPSP to TPP for downloading transactions
     * @param aspspConsentDataProvider Provides access to read/write encrypted data to be stored in the consent management system
     * @return A response, containing a stream for downloading transactions and it's content type
     */
    default SpiResponse<SpiTransactionsDownloadResponse> requestTransactionsByDownloadLink(@NotNull SpiContextData contextData, @NotNull SpiAccountConsent accountConsent, @NotNull String downloadUrlSuffix, @NotNull SpiAspspConsentDataProvider aspspConsentDataProvider) {
